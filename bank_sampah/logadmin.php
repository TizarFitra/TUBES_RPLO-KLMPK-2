...
if (isset($_POST['login'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM pengelola WHERE username = ?");
...
<head>
    ...
    <title>Login Pengelola - Bank Sampah</title>
...
<body class="bg-gradient-to-br from-green-500 to-green-700 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 space-y-6 leaf-pattern">
        <div class="text-center space-y-2">
            ...
            <h2 class="text-3xl font-bold text-gray-800">Login Pengelola</h2>
        ...
        <div class="text-center space-y-4">
            <p class="text-gray-600">Belum punya akun pengelola?</p>
            <a href="regadmin.php" 
               class="inline-block w-full bg-green-100 text-green-600 py-2 px-4 rounded-lg hover:bg-green-200 transition duration-300 flex items-center justify-center space-x-2">
